...
import pandas as pd
from PathDSP_exp_target.validation import prep_data, train_val
...
if __name__ == '__main__':
    ...
    # import data
    input_data_path = args.dataroot + 'PathDSP/' + args.pathway + '/'
    ...
    cl_exp = pd.read_csv(input_data_path + 'exp_NES.csv', header=0, index_col=0).to_numpy()
    cl_cnv = pd.read_csv(input_data_path + 'cnv_zscore.csv', header=0, index_col=0).to_numpy()
    cl_mut = pd.read_csv(input_data_path + 'mut_zscore.csv', header=0, index_col=0).to_numpy()
    drug_fp = pd.read_csv(common_data_path + 'drug_fp_matrix.csv', header=0, index_col=0).to_numpy()
    drug_target = pd.read_csv(input_data_path + 'target_zscore.csv', header=0, index_col=0).to_numpy()
